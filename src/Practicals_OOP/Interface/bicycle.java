...
public class bicycle implements Vehicle{
    ...
    public void speedUp(int speedToAdd) {
        speed += speedToAdd;
    System.out.println("Bicycle's  Speed is increased by "+speedToAdd+"km/hr\n Now Speed is "+speed+"\n");
    }
    @Override
    public void applyBreaks() {
    areBrakesApplied = false;
    System.out.println("Bicycle's  Breaks are now applied \n areBrakesApplied property is "+areBrakesApplied+"\n");

    }
    @Override
    public void GearChange(int gno) {
    System.out.println("Bicycle's  gear was changed from "+gear+"to "+gno+"\n");
    gear= gno;
    }
}
